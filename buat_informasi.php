...
if(isset($_POST["unggah"])){
  ...
  if(UpInformasi($_POST) > 0 ){
      echo "
      <script>
      alert('Informasi Berhasil Ditambah !');
      ...
      echo "
      <script>
      alert('Informasi Gagal Ditambah !');
            ...
            <div class="row justify-content-center">
                <div class="col-lg-9 col-md-12 col-12 text-center">
                    <div class="page-banner-content">
                        <h1 class="display-4 font-weight-bold">UNGGAH INFORMASI</h1>
        ...
        <div class="">
            <div class="container">
              ...
              <div class="form-group">
                <form action="up_informasi.php" method="POST" enctype="multipart/form-data">
