<?php 
session_start();
include 'function/edit_berita.php';
$id = $_GET['id'];
            ...
            <div class="row justify-content-center">
                <div class="col-lg-9 col-md-12 col-12 text-center">
                    <div class="page-banner-content">
                        <h1 class="display-4 font-weight-bold">EDIT BERITA</h1>
        ...
        <div class="">
            <div class="container">
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="gambarLama" value="<?=$hasilubah['gambar']?>">
                <br>
              ...
              <div class="form-group">
                  <label for="tgl">Tanggal</label>
                    <input type="date" name="tgl" class="form-control" value="<?=$hasilubah['tgl']?>">
                  </div>
                        ...
                        <textarea class="form-control" name="isi" rows="10" placeholder="Isi Berita" ><?=$hasilubah['isi']?></textarea>
                          ...
                          <!--Upload gambar-->
                            ...
                            <div class="form-group">
                              ...
                              <img src="images/<?=$hasilubah['gambar'];?>" height="130"><br><br>
