<?php 
session_start();
include 'function/up_kegiatan.php';
if(isset($_POST["unggah"])){

  if(UpKegiatan($_POST) > 0 ){
      echo "
      <script>
      ...
      echo "
      <script>
      alert('Kegiatan Gagal Ditambah !');
      document.location.href ='buat_kegiatan.php';
      </script>
      ";    
  }
            ...
            <div class="row justify-content-center">
                <div class="col-lg-9 col-md-12 col-12 text-center">
                    <div class="page-banner-content">
                        <h1 class="display-4 font-weight-bold">UNGGAH KEGIATAN</h1>
